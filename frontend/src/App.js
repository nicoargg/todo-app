...
function App() {
  ...
  return (
    <div className="App">
      Hello, world!
      Farm stack
      <div className='App list-group-item jusify-content-center align-items-center mx-auto' style={{ "width": "400px", "backgroundColor": "white", "marginTop": "15px" }}>
        <h1 className='card text-white bg-primary mb-1' style={{ "maxWidth": "20rm" }}>
          Task Manager
        </h1>
